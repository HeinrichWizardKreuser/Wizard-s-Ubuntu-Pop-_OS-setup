...
"nnoremap <DEL> i<DEL>
nnoremap <CR> i<CR>
" When at end of line in normal mode and press arrow right, go to insert mode and go right
nnoremap <expr> <RIGHT> <sid>curs_ln_end() ? '<RIGHT>' : 'i<RIGHT>'

"____________________________________ COMMENT __________________________
...
"_______________________________ OTHER GOODIES _________________________
